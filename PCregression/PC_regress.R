##This function runs PC regressions and pQTL identification using on GelPrep MS data and previously compiled cache files.
# This function should be run in a parent directory to 'data'. In data are the required genotype cache files

#usage from the terminal for eg 3 PCs: 
# 'Rscript ZiaDataPCregress.R 3'
...
#get the number of PCs to regress from passed arguement
numPCs <- as.numeric(argv[1])
