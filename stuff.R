...
#this function should be applied early in the combined workflow. Perhaps within the assignprot function.

##Loop to assign protein ids, H/L values and ibaq values to phosphosites for normalization using "protein groups" file produced from the phospho workup. Intellegent naming of the columns as well. 

#When there are multiple protein groups that could match the phosphosite I choose the one with the most unique/razor ids


#########################
#inputs needed are ME/ME1 and 'protein' from SCX-IMAC protein groups file WITHOUT SUBSETTING BY ONLY IDENTIFIED BY SITE!!
 #this function can be run within Assignprot as the first pass and then return the multisiteexpanded 1 dataframe. Need to include the 'only identified by site flag'
