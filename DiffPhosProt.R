DiffPhosProt <- function(protein1, quantiled, multExpanded1_withDE){


#subset protein1 by id
tmp <- protein1[protein1$id %in% row.names(quantiled),]

#revert names of quantiled back to 'HL'
names(quantiled) <- gsub(names(quantiled), pattern = "LH", replacement = "HL")
